...
const Work = ({ isDarkMode }) => {
  return (
    ...
    >
      ...
      >
          Here are some of the projects I've worked on recently — from full-stack web apps to AI-powered systems. Each project reflects my focus on clean code, real-world problem-solving, and modern tech like React, Spring Boot, MongoDB, and AI tools like YOLO and OpenCV.
      </motion.p>
